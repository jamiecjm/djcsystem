...
namespace :eliteone do
  ...
  task :set_custom_config do
    ...
    ENV['SCHEMA'] = "eliteone_db/schema.rb"
    Rails.application.config.paths['db'] = ["eliteone_db"]
    # Rails.application.config.paths['db/migrate'] = ["eliteone_db/migrate"]
    Rails.application.config.paths['db/seeds.rb'] = ["eliteone_db/seeds.rb"]
